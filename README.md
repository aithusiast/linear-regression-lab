...
A hands-on laboratory for exploring and implementing **linear regression** techniques using real-world datasets. This project covers the full ML workflow — from data loading and EDA to model training, evaluation, and visualization — all inside Jupyter Notebooks.
...
| Dataset | Source |
|---------|--------|
| *nehalbirla/vehicle-dataset-from-cardekho* | [Kaggle](https://www.kaggle.com/datasets) |
...
```bash
git clone https://github.com/aithusiast/linear-regression-lab.git
cd linear-regression-lab
```
